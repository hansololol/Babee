...
input[type="button"]:hover {
    ...
    <script type="text/javascript">
        ...
        $('input[name="goods_image_name1"]').on("change", function (event) {
          ...
          reader.onload = function (e) {
            $(".file-preview1").html(
              '<img src="' +
                e.target.result +
                '" alt="Preview" style="width: 300px; height: 300px; margin: 10px 0 10px 0; border-radius: 20%;"> <br>'
            );
          };
      ...
      $(document).ready(function () {
    	    $('form').submit(function (e) {
    	        ...
    	        var userConfirmation = confirm('상품을 등록하시겠습니까?');
  ...
  <body>
  <div style="border: 1px solid #ccc;box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.2);border-radius: 10px;margin: 10px;padding: 10px;background-color: #fff;width: 1000px;margin-top: -0px;margin-left: 150px;">
  <form
      ...
      >
    <br />
    <h1 style="margin-right: 90px;">상품 등록하기</h1>
    <br /><br />
    ...
    margin: -465px 00px 0px -330px; " ><!-- 위 왼 밑 오 -->
          <label for="goods_image_name1" style="display: block; margin-left: 120px; margin-bottom: 10px;"><b>메인 이미지</b></label>
          
          <input type="file" name="goods_image_name1" style="margin-left: 55px;"/>
          <div style="width: 320px; height: 320px; margin-left: 10px; margin-top: 10px; position: relative;">
		    <div style="border: 1px dashed #000 ; width: 320px; height: 320px; position: absolute; top: 0; left: -10px;"></div>
		    <div class="file-preview1" style="width: 310px; height: 310px; overflow: hidden;"></div>
		</div>
	    </div>
        </div>
        ...
        <input style="margin-bottom: 20px;" type="submit" value="상품 등록" />
