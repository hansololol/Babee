          ...
          <tr>
            <td>
              ...
              <p style="display: inline-block">
                ${memberInfo.member_name}님 안녕하세요
              </p>
            </td>
          </tr>
        </table>
        ...
        <div style="width: 100%">
          <table class="seller-table" style="width: 100%">
            ...
            <c:forEach var="member" items="${member}" varStatus="memberNO">
              <tr style="height: 50px; border-bottom: 1px solid #ccc">
                ...
                <script>
                  alert("${member.member_delDate}");
                </script>
                <td>
                  <a
                    href="${contextPath}/admin/member/memberManageDetail.do?page=adminPage&member_id=${member.member_id}"
                    >${member.member_id}</a
                  >
                </td>
          ...
          <div class="paging-container">
            <c:if test="${section>1}">
              <a
                class="paging-button"
                href="${contextPath}/admin/member/memberManageList.do?page=adminPage&section=${section-1}&pageNum=1"
                >이전</a
              >
            </c:if>
            <c:forEach var="i" begin="1" end="5">
              <a
                class="paging-button"
                href="${contextPath}/admin/member/memberManageList.do?page=adminPage&section=${section}&pageNum=${i}"
                >${((section-1)*5) + i}</a
              >
            </c:forEach>
            <a
