...
<div class="menu-container">
        <div class="menu-options">
            <div class="menu-option" id="total">
                <a href="${contextPath}/admin/member/sellerManageList.do?page=adminPage" style="color: black; background-color:orange; border-radius: 5px; padding: 10px;">사업자 목록</a>
            </div>
            <div class="menu-option" id="wait">
                <a href="${contextPath}/admin/member/sellerManageWait.do?page=adminPage" style="color: black; margin-right: 380px;">사업자 등록 요청</a>
            </div>
    ...
    <div class="paging-container">
        <c:if test="${section>1}">
            <a class="paging-button" href="${contextPath}/admin/member/sellerManageList.do?page=adminPage&section=${section-1}&pageNum=1">이전</a>
        
        </c:if>
        <c:forEach var="i" begin="1" end="5">
            <a class="paging-button" href="${contextPath}/admin/member/sellerManageList.do?page=adminPage&section=${section}&pageNum=${i}">${((section-1)*5) + i}</a>
        
        </c:forEach>
        <a class="paging-button" href="${contextPath}/admin/member/sellerManageList.do?page=adminPage&section=${section+1}&pageNum=1">다음</a>
    </div>
    <br><br><br><br><br>
</body>
</html>