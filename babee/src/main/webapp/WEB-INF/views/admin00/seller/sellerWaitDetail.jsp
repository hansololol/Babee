...
<html>
  ...
  <body>
    ...
    <form
      name="frmSellerWaitDetail"
      action="${contextPath}/admin/member/sellerRegister.do"
      method="post"
      enctype="multipart/form-data"
    >
      <div style="width: 66%; margin: 0 auto">
        <h3 style="display: inline-block; margin-bottom: 8px; margin-top: 10px">
          ${seller.seller_company} &nbsp;
          <h6 style="display: inline-block; margin-bottom: 8px">
            ${seller.seller_joinDate}
          </h6>
        </h3>
      ...
      <div style="margin: 0 auto">
        <table class="store_basic" style="margin: 0 auto">
          <tr>
            <td width="200">
              <h4 align="center">
                <span style="color: #cc9900">●</span>기본정보
              </h4>
            </td>
            <td>&nbsp;</td>
          </tr>
        ...
        >
          ...
          <tr>
            ...
            <td width="200px">
              ${seller.seller_tel1} - ${seller.seller_tel2} -
              ${seller.seller_tel3}
            </td>
            <td width="200px" align="center">휴대전화</td>
            <td width="200px">
              ${seller.seller_hp1} - ${seller.seller_hp2} - ${seller.seller_hp3}
            </td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="3">
              ${seller.seller_roadAddr} ${seller.seller_namujiAddr}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td width="200">
              <h4 align="center" style="margin-top: 10px">
                <span style="color: #cc9900">●</span> 사업체 정보
              </h4>
            </td>
            <td>&nbsp;</td>
          </tr>
        ...
        <table class="store_basic" style="margin: 0 auto">
          <tr>
            <td width="200">
              <h4 text-align="center" style="margin-top: 10px">
                <span style="color: #cc9900">●</span> 서류 정보
              </h4>
            </td>
            <td>&nbsp;</td>
          </tr>
        ...
        <div style="margin: 0 auto">
          ...
          <div class="tab-content" id="myTabContent" style="margin: 30px auto">
            ...
            >
              <img
                src="${contextPath}/thumbnails.do?goods_id=${seller.seller_id}&fileName=${seller.seller_img1}"
                width="400px;"
              />
            </div>
            <div
              ...
              tabindex="0"
            >
              <img src="/image/ex01.jpg" width="600px;" />
            </div>
            <div
              class="tab-pane fade"
              id="contact-tab-pane"
              ...
              tabindex="0"
            >
              <br /><br /><img src="/image/통장사본.jpg" width="400px;" />
            </div>
          </div>
          ...
          <div style="margin: 30px auto">
            ...
            <input
              ...
              id="access"
              value="승인"
              onClick="fn_seller_Register('${seller.seller_id}', '승인')"
            />
              ...
              <tr>
                ...
                <td>
                  <input
                    type="button"
                    value="입력"
                    onClick="fn_seller_Refuse('${seller.seller_id}', '반려', '${seller.seller_refuse}')"
                  />
                </td>
              </tr>
            </table>
