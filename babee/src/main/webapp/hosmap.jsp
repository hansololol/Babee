...
<head>
    ...
    <style>
.map_wrap, .map_wrap * {margin-left:auto;padding:0;font-family:'Malgun Gothic',dotum,'돋움',sans-serif;font-size:12px;}
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="${memberInfo.member_jibunAddr}근처 산부인과" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6edf9c12e03c6b6469eb19b942d63395&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
